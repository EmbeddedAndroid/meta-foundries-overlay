...
do_install() {
    ...
    install -m 0644 ${UNPACKDIR}/weston.ini ${D}${datadir}/dragonwing/weston.ini
    ...
    install -m 0644 ${UNPACKDIR}/weston-docker-group.conf \
    ...
    install -m 0644 ${UNPACKDIR}/dragonwing-wallpaper.png ${D}${datadir}/dragonwing/dragonwing-wallpaper.png
    install -m 0644 ${UNPACKDIR}/kiosk-marketplace.png    ${D}${datadir}/dragonwing/icons/kiosk-marketplace.png

    # Kiosk launcher target + stop helper.
    install -d ${D}${bindir}
    install -m 0755 ${UNPACKDIR}/kiosk-start.sh ${D}${bindir}/dragonwing-kiosk-start
    install -m 0755 ${UNPACKDIR}/kiosk-stop.sh  ${D}${bindir}/dragonwing-kiosk-stop
    ...
    install -m 0644 ${UNPACKDIR}/kiosk/Dockerfile ${D}${datadir}/dragonwing/kiosk/Dockerfile
    install -m 0755 ${UNPACKDIR}/kiosk/launch.sh  ${D}${datadir}/dragonwing/kiosk/launch.sh
}
