...
do_install() {
    ...
    install -m 0755 $picked/libQnnHtpV75CalculatorStub.so ${D}${datadir}/dragonwing/cam-test/qnn-libs/
    install -m 0755 $picked/libQnnHtpV75Stub.so           ${D}${datadir}/dragonwing/cam-test/qnn-libs/
